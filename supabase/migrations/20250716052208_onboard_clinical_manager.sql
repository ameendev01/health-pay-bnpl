...
CREATE OR REPLACE FUNCTION onboard_clinical_manager(
    ...
    p_npi varchar,
    p_expiry_date varchar,
    p_state_of_issuance varchar,
...
BEGIN
    ...
    INSERT INTO clinics (
        organization_id, medical_license_number, npi, expiry_date, state_of_issuance, 
        street_address, suite, zip_code, phone, time_zone, medical_specialty, 
        price_range, monthly_volume, ehr_vendor, other_ehr
    ) VALUES (
        v_organization_id, p_medical_license_number, p_npi, p_expiry_date, p_state_of_issuance,
        p_street_address, p_suite, p_zip_code, p_phone, p_time_zone, p_medical_specialty,
        p_price_range, p_monthly_volume, p_ehr_vendor, p_other_ehr
    );
    ...
    INSERT INTO bank_accounts (
        organization_id, routing_number_encrypted, account_number_encrypted, account_type, bank_name_encrypted
    ) VALUES (
        v_organization_id,
