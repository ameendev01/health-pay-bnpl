...
BEGIN
    ...
    INSERT INTO clinics (
        organization_id, medical_license_number, npi, license_expiry_date, state_of_issuance, 
        street_address, suite, zip_code, phone, time_zone, medical_specialty, 
        price_range, monthly_volume, ehr_vendor, other_ehr
    ) VALUES (
        v_organization_id, p_medical_license_number, p_npi, p_license_expiry_date, p_state_of_issuance,
