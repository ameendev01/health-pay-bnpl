...
export default function DashboardPage() {
  ...
  if (isLoadingTransactions) {
    return (
      <div className="min-h-screen bg-[#d5f9fb] p-6">
        <div className="h-[calc(100vh-3rem)] rounded-2xl bg-[#fefcf5] overflow-y-auto shadow-xl border border-[#e7e4db]/50 p-8">
  ...
  return (
    <div className="min-h-screen bg-[#d5f9fb] p-6">
      <div className="h-[calc(100vh-3rem)] rounded-2xl bg-[#fefcf5] overflow-y-auto shadow-xl border border-[#e7e4db]/50">
        <main className="p-8">
