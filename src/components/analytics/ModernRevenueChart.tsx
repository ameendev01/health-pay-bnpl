...
import { RefreshCw, Eye, BarChart3, TrendingUp } from 'lucide-react';
...
const enhancedData = [
  { month: 'Jan', amount: 185000, plans: 234, clinics: 45, prevAmount: 165000, prevPlans: 210 },
  { month: 'Feb', amount: 220000, plans: 287, clinics: 48, prevAmount: 190000, prevPlans: 245 },
  { month: 'Mar', amount: 195000, plans: 256, clinics: 52, prevAmount: 175000, prevPlans: 230 },
  { month: 'Apr', amount: 260000, plans: 345, clinics: 55, prevAmount: 220000, prevPlans: 290 },
  { month: 'May', amount: 245000, plans: 312, clinics: 58, prevAmount: 210000, prevPlans: 275 },
  { month: 'Jun', amount: 290000, plans: 398, clinics: 62, prevAmount: 250000, prevPlans: 340 },
];
...
export default function ModernRevenueChart({ compareMode, onCompareModeChange }: ModernRevenueChartProps) {
          ...
          <div className="space-y-1">
            ...
            {compareMode !== 'off' && (
              <div className="flex items-center justify-between space-x-4">
                ...
                <span className="font-semibold text-gray-700">${data.prevAmount.toLocaleString()}</span>
              </div>
            )}
            {showPlans && (
              <div className="flex items-center justify-between space-x-4">
                <span className="text-sm text-gray-600">Plans:</span>
                <span className="font-semibold text-gray-900">{data.plans}</span>
              </div>
            )}
          </div>
          {annotation && (
            <div className="mt-2 pt-2 border-t border-gray-100">
              <div className="flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full ${
                  annotation.type === 'campaign' ? 'bg-blue-500' : 'bg-green-500'
                }`}></div>
                <span className="text-xs text-gray-600">{annotation.event}</span>
              </div>
            </div>
          )}
        </div>
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Monthly revenue with growth patterns and key events</p>
          </div>
          <div className="flex items-center space-x-2">
            <button
      ...
      <CardContent>
          ...
          >
            ...
            {compareMode !== 'off' && (
              <Line 
                ...
                strokeDasharray="5 5"
                dot={false}
                name={compareMode === 'mom' ? 'Previous Month' : 'Previous Year'}
              />
            )}
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-green-50 rounded-lg p-4">
            ...
            <p className="text-xl font-bold text-gray-900 tabular-nums">+18.5%</p>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-gray-700">Peak Month</span>
            </div>
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            ...
            <p className="text-xl font-bold text-gray-900 tabular-nums">$315k</p>
